...

{
  ...
  "invoice_arithmetic_fob_status": "FILL: PASS if difference = 0.00 | FAIL if difference ≠ 0.00",
  ...
  "invoice_arithmetic_cif_status": "FILL: PASS if difference ≤ 1.00 | FAIL if difference > 1.00",
  ...
  "insurance_coverage_check_status": "FILL: PASS if coverage% >= 110% | FAIL if coverage% < 110% | UNABLE TO CHECK — document missing",
  ...
  "boe_amount_vs_invoice_cif_status": "FILL: PASS if difference = 0.00 | FAIL if difference ≠ 0.00 | UNABLE TO CHECK — document missing",
  ...
  "date_all_vs_lc_expiry_detail": "FILL: lc_expiry_date=[value]. Check each document's primary date: Commercial Invoice=[date] [PASS/FAIL], Bill of Lading=[date] [PASS/FAIL], COO=[date] [PASS/FAIL], Insurance=[date] [PASS/FAIL], Inspection=[date] [PASS/FAIL], BOE=[date] [PASS/FAIL], Packing List=[date] [PASS/FAIL]. If ALL <= lc_expiry → 'All document dates are within LC expiry date.' If ANY exceed → '[document] dated [value] exceeds LC expiry date [value] — CRITICAL.'",
  ...
  "presentation_period_status": "FILL: PASS if today_ist <= presentation_deadline AND today_ist <= lc_expiry | FAIL if either condition breached | UNABLE TO CHECK — document missing",
  ...
  "stale_bl_status": "FILL: PASS if today_ist <= stale_deadline | FAIL if today_ist > stale_deadline | UNABLE TO CHECK — document missing",
  ...
  "missing_documents": ["FILL: list any of the 8 expected document types not present in the input — plain strings only. If none missing write empty array []"],
